...
class HouseHoldsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create house_hold" do
    assert_difference('HouseHold.count') do
      post house_holds_url, params: { house_hold: { chore_id: @house_hold.chore_id, member_id: @house_hold.member_id, name: @house_hold.name } }, as: :json
    end
  ...
  test "should update house_hold" do
    patch house_hold_url(@house_hold), params: { house_hold: { chore_id: @house_hold.chore_id, member_id: @house_hold.member_id, name: @house_hold.name } }, as: :json
    assert_response 200
  end
